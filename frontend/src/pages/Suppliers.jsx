...
import { Plus, Search, Edit2, Trash2, Truck, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h2 className="text-2xl font-bold text-ink-900">Suppliers</h2>
          <p className="text-sm text-slate-500">Manage vendors and inventory suppliers.</p>
        </div>
        <button
              ...
              <tbody className="divide-y divide-slate-100">
                {suppliers.map((sup) => (
                  <tr key={sup._id} className="hover:bg-slate-50/80 transition-colors">
                    <td className="px-6 py-4 font-semibold text-ink-900">{sup.name}</td>
